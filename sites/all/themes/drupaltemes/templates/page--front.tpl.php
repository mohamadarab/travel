	...
	<!-- Banner -->
	<section class="tm-banner hidden-xs hidden-sm">
		<!-- Flexslider -->
	...
	<section class="container tm-home-section-1" id="more">
		<div class="row">
			 <?php print render($page['top_tour']); ?>
		</div>
		...
		<div class="section-margin-top">
			<div class="row">				
				<div class="tm-section-header">
					...
					<div class="col-lg-6 col-md-6 col-sm-6"><h2 class="tm-section-title">تورهای لحظه آخر</h2></div>
					<div class="col-lg-3 col-md-3 col-sm-3"><hr></div>	
				</div>
			</div>
			<div class="row">
				<?php print render($page['recent_tour']); ?>
			</div>
